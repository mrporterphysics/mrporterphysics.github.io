...
- Watch: Krakatoa – The Great Volcanic Eruption (0:00–3:32) [Krakatoa – the Great Volcanic Eruption](https://www.youtube.com/watch?v=MrEIT66oPqU&t=3778s)
...
<iframe width="1100" height="515" src="https://www.youtube.com/embed/MrEIT66oPqU?si=KzxWMaXcxpG-ASZO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- Tools:
  - Data Visualization: [Global Seismogram Viewer](http://ds.iris.edu/gsv/)
  - Simulation: [Seismic Waves](https://ds.iris.edu/seismon/swaves/index.php?lat=38.32&lon=142.36&depth=32&mag=9&title=2011+Tohoku+Quake+%26+Tsunami&date=2011-03-11T05:46Z&w_terrain=true&wiki=https://en.wikipedia.org/wiki/2011_Tohoku_earthquake_and_tsunami)
...
### Explore 1 — Materials & Density (Part 2 setup)

- Goal: Connect layering in Earth to density differences using a simple lab.
- Materials:
  - Water (20 mL), Isopropyl alcohol (20 mL), Vegetable oil (20 mL)
  - Graduated cylinders (2), Balance (grams), Food coloring (3 colors)
- Safety & Accuracy:
  - Read the meniscus correctly
  - Measure mass of empty cylinder before liquid
  - Wipe spills; alcohol is flammable

---

Slide 9: Explore 1 — Density Procedure (Part 2)
- Step 1: Mass empty cylinder (g).
- Step 2: Add 20 mL liquid (meniscus at 20 mL); measure combined mass.
- Step 3: Mass of liquid alone = combined mass – empty cylinder mass.
- Step 4: Density = mass (g) / volume (cm³) [20 mL = 20 cm³].

Table (to fill):
- Mass empty cylinder (g)
- Mass cylinder + liquid (g)
- Mass liquid alone (g)
- Density (g/cm³)

—

Slide 10: Explore 1 — Density Column (Part 2)
- Color a 10 mL sample of water and alcohol (different colors).
- Layer ~10 mL each of alcohol, water, oil (pour gently) in one cylinder.
- Predict & Label: Bottom, middle, top positions. Explain using density data.
- Repeat in a different order in cylinder #2: Do they still separate the same way?

Prompt: How do your observations confirm (or challenge) your predictions?

—

Slide 11: Explore 1 — See-Think-Wonder (Seismic + Density)
