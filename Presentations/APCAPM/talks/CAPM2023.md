...
# Card Sort: Carts and Ramps 

1. Sort Cards together (Description, XT Graph, VT Graph)
2. Once **all** cards are sorted copy down predictions in packet 
3. Set up ramp and smart cart to "check" your answers
4. Add acceleration graph to actual column
5. Complete Summary Chart
6. Whiteboard assigned Situation
