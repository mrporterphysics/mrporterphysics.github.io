...
The ***linear momentum*** can be thought of as the _quantity of motion_ 
...
-> $\vec{p}$ has units of $\text{kg}\cdot\text{m/s}$ or $\text{N}\cdot\text{s}$
...
<video width="450" height="600" controls src="eggtoss.mov"> </video>
