...
# Different Rotation Terms

- Revolution (rev, $\theta$) - one spin
- Rotation (rot, $\theta$) - one spin
- Period (s, $T$) - Time for one spin
- Revolutions per minute (rev/min or rpm, $\omega$)
- Radians per second (rad/s, $\omega$)
